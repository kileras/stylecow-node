(function (tree) {
	...
	tree.import.prototype.execute = function (settings, data, rootData) {
		var k, plugin;
	...
	tree.import.prototype.toString = function (options) {
		return options.ruleStart + '@import "' + this.url + '"' + options.ruleEnd;
	};
